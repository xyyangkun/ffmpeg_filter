...
if __name__ == "__main__":
    ...
    parser.add_option('-t', '--type', dest='type', default="00", type='string', help='00 show blue 01 shadow blue')
    opts, args = parser.parse_args()
    tcp_sock = prepare_sock(opts.ip, opts.port)

    tcp_sock.send(get_background_data(opts.type))
